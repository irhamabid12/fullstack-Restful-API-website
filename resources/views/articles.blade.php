                    ...
                    <div class="row row-cols-1 row-cols-md-3 g-4 mb-3" >
                        ...
                        <div class="col">
                          <div class="card h-100 rounded shadow">
                            <img src="{{ asset("storage/image/$item->image") }}" class="card-img-top" alt="image" style="object-fit: cover; max-height: 15rem; min-height: 15rem;">
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                <div class="d-flex mb-2">
                                    ...
                                    <div class="p-2">
                                        <a href="/article/detail/{{ $item->id }}" class=""><i class="bi bi-info-circle"></i></a>
                                        <a href="#updateModal{{  $item->id }}" role="button" data-bs-toggle="modal" class=""><i class="bi bi-pencil-square"></i></a>
                                        <a href="/article/delete/{{ $item->id }}" class=""><i class="bi bi-trash"></i></a>
                                    </div>
                                </div>
                            </div>
                          </div>
                        ...
                        <div class="modal fade" id="updateModal{{  $item->id }}" tabindex="-1" aria-labelledby="detaillModal" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <img src="{{ asset("storage/image/$item->image") }}" class="card-img-top" alt="image"style="object-fit: cover; max-height: 18rem;">
                                    <div class="modal-body">
